...
public class ArgsScannerTest {
	...
	public void testImmediate7() {
		try {
			scanner.immediateString("\\[abc]d etc.");
			fail("exception expected");
		} catch (Exception e) {
	...
	@Test
	public void testImmediate9() {
		try {
			String[] result = scanner.immediateString("= this");
			assertEquals(null, result[0]);
		} catch (Exception e) {
			fail("unexpected exception");
		}
